...
import LodgeTable from "@/components/dashboard-components/LodgeTable"
...
export function Dashboard() {
    return (
        <div className="pt-12 flex min-h-screen w-full flex-col bg-muted/40">
